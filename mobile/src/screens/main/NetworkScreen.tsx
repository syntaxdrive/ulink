...
export default function NetworkScreen() {
      ...
      <View style={styles.profileCard}>
        ...
        <View style={styles.profileInfo}>
          <View style={styles.nameRow}>
            <Text style={[styles.profileName, { color: isDark ? '#FFFFFF' : '#111827' }]} numberOfLines={1}>
              {item.name || item.username || 'Unknown'}
            </Text>
            {item.is_verified && <VerifiedBadge size={14} />}
          </View>
          {item.headline ? (
            <Text style={[styles.profileHeadline, { color: isDark ? '#9CA3AF' : '#6B7280' }]} numberOfLines={1}>
              {item.headline}
            </Text>
          ) : null}
          {item.university ? (
            <View style={styles.uniRow}>
              ...
              <Text style={[styles.profileUniversity, { color: isDark ? '#9CA3AF' : '#6B7280' }]} numberOfLines={1}>
                {' '}{item.university}
              </Text>
            </View>
          ) : null}
        ...
        {state === 'connect' && (
          <TouchableOpacity
            style={[styles.connectBtn, { backgroundColor: isDark ? '#FFFFFF' : '#000000' }]}
          ...
          >
            {isProcessing ? (
              ...
              <>
                <UserPlus size={13} color={isDark ? '#000000' : '#FFFFFF'} />
                <Text style={[styles.connectBtnText, { color: isDark ? '#000000' : '#FFFFFF' }]}> Connect</Text>
              </>
            )}
          </TouchableOpacity>
        )}
        {state === 'pending' && (
          <View style={[styles.pendingBtn, { backgroundColor: isDark ? '#27272A' : '#F3F4F6' }]}>
            <Text style={[styles.pendingBtnText, { color: isDark ? '#9CA3AF' : '#6B7280' }]}>Sent</Text>
          </View>
        )}
        {state === 'connected' && (
          <View style={[styles.connectedBtn, { backgroundColor: isDark ? 'rgba(16, 185, 129, 0.15)' : '#ECFDF5' }]}>
            <Check size={13} color="#10B981" />
            <Text style={[styles.connectedBtnText, { color: '#10B981' }]}> Connected</Text>
          </View>
        )}
      </View>
    );
  ...
  const renderNetworkCard = ({ item }: { item: Profile }) => (
    <View style={styles.profileCard}>
      ...
      <TouchableOpacity
        style={[styles.messageBtn, { backgroundColor: isDark ? '#27272A' : '#F3F4F6' }]}
        onPress={() => navigation.navigate('Messages')}
      >
        <MessageCircle size={15} color={isDark ? '#FFFFFF' : '#111827'} />
      </TouchableOpacity>
    </View>
  );
    ...
    return (
      <View
        style={[
          styles.pendingCard,
          {
            backgroundColor: isDark ? '#18181B' : '#FEF3C7',
      ...
      >
        ...
        <View style={styles.profileInfo}>
          <View style={styles.nameRow}>
            ...
            {requester.is_verified && <CheckCircle2 size={13} color="#10B981" style={{ marginLeft: 3 }} />}
          </View>
        ...
        <View style={styles.requestActions}>
          ...
          <TouchableOpacity
            style={[styles.rejectBtn, { backgroundColor: isDark ? '#27272A' : '#E5E7EB' }, isProcessing && { opacity: 0.5 }]}
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: isDark ? '#000000' : '#FFFFFF' }]}>
      ...
      <View style={[styles.header, { borderBottomColor: isDark ? '#1F1F23' : '#E5E7EB' }]}>
        <Text style={[styles.headerTitle, { color: isDark ? '#FFFFFF' : '#111827' }]}>Network</Text>
          ...
          <TouchableOpacity
            ...
            style={[
              styles.leaderboardBtn,
              {
                ...
                borderColor: isDark ? '#3F3F46' : '#FDE047',
              },
            ]}
          >
            <Trophy size={19} color={isDark ? '#F59E0B' : '#D97706'} />
          </TouchableOpacity>
        </View>
      </View>

      {/* Tabs */}
      <View style={[styles.tabBar, { backgroundColor: isDark ? '#000000' : '#FFFFFF', borderBottomColor: isDark ? '#1F1F23' : '#E5E7EB' }]}>
        <TouchableOpacity
          style={[styles.tab, activeTab === 'discover' && { borderBottomColor: isDark ? '#FFFFFF' : '#000000' }]}
        ...
        >
          <Text
            style={[
              ...
              activeTab === 'discover' && { color: isDark ? '#FFFFFF' : '#000000', fontWeight: '800' },
            ]}
          >
            Discover
          </Text>
        ...
        <TouchableOpacity
          style={[styles.tab, activeTab === 'network' && { borderBottomColor: isDark ? '#FFFFFF' : '#000000' }]}
        ...
        >
          <Text
            style={[
              styles.tabText,
              { color: isDark ? '#71717A' : '#6B7280' },
              activeTab === 'network' && { color: isDark ? '#FFFFFF' : '#000000', fontWeight: '800' },
            ]}
          >
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View>
              ...
              >
                <Search size={16} color={isDark ? '#71717A' : '#9CA3AF'} style={styles.searchIcon} />
                <TextInput
                ...
                />
                {searching && <ActivityIndicator size="small" color="#10B981" style={{ marginRight: 12 }} />}
              </View>
            </View>
          }
          ListEmptyComponent={
            isDiscoverLoading ? (
              ...
              <View style={styles.emptyContainer}>
                <Users size={40} color={isDark ? '#52525B' : '#D1D5DB'} />
                <Text style={[styles.emptyText, { color: isDark ? '#A1A1AA' : '#6B7280' }]}>
          ...
          ItemSeparatorComponent={() => (
            <View style={[styles.separator, { backgroundColor: isDark ? '#1F1F23' : '#F3F4F6' }]} />
          )}
        />
      )}
              ...
              {isNetworkLoading ? (
                ...
                <View style={styles.emptyContainer}>
                  ...
                  <Text style={[styles.emptySubText, { color: isDark ? '#9CA3AF' : '#6B7280' }]}>
                    Switch to Discover to find people to connect with
                  </Text>
                </View>
              ) : myNetwork.length > 0 ? (
