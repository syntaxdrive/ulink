      ...
      >
        ...
        <View style={[styles.header, { borderBottomColor: isDark ? '#1F1F23' : '#E5E7EB' }]}>
          <View style={styles.headerTitleRow}>
            <Text style={[styles.title, { color: isDark ? '#FFFFFF' : '#111827' }]}>New Post</Text>
          ...
          <TouchableOpacity
            style={[styles.publishBtn, { backgroundColor: isDark ? '#FFFFFF' : '#000000' }]}
            onPress={handleCreatePost}
          >
            <Send size={15} color={isDark ? '#000000' : '#ffffff'} />
            <Text style={[styles.publishText, { color: isDark ? '#000000' : '#ffffff' }]}>Publish</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={[styles.mediaBar, { backgroundColor: isDark ? '#121214' : '#FFFFFF', borderTopColor: isDark ? '#1F1F23' : '#E5E7EB' }]}>
          <Text style={[styles.mediaBarLabel, { color: isDark ? '#9CA3AF' : '#6B7280' }]}>Attach Content:</Text>
          ...
          <View style={styles.mediaButtonsRow}>
            ...
            <TouchableOpacity
              style={[
                ...
                { backgroundColor: isDark ? '#1E1E24' : '#F3F4F6', borderColor: isDark ? '#27272A' : '#E5E7EB' },
            ...
            >
              <ImageIcon
                size={18}
                color={selectedImages.length > 0 ? '#000000' : (isDark ? '#FFFFFF' : '#111827')}
              />
              <Text
                style={[
            ...
            >
              <VideoIcon
                size={18}
                color={selectedVideo ? '#000000' : (isDark ? '#FFFFFF' : '#111827')}
              />
              <Text
                style={[
                  styles.mediaOptionText,
            ...
            <TouchableOpacity
              style={[
                styles.mediaOptionBtn,
                { backgroundColor: isDark ? '#1E1E24' : '#F3F4F6', borderColor: isDark ? '#27272A' : '#E5E7EB' },
                showPollCreator && styles.mediaOptionActive,
              ]}
              onPress={() => setShowPollCreator(!showPollCreator)}
            >
              <BarChart2
                size={18}
                color={showPollCreator ? '#10B981' : (isDark ? '#FFFFFF' : '#111827')}
              />
              <Text
                style={[
                  styles.mediaOptionText,
                  { color: isDark ? '#FFFFFF' : '#111827' },
                  showPollCreator && { color: '#10B981', fontWeight: '700' },
                ]}
              >
                Poll
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.mediaOptionBtn,
                { backgroundColor: isDark ? '#1E1E24' : '#F3F4F6', borderColor: isDark ? '#27272A' : '#E5E7EB' },
                showUrlInput && styles.mediaOptionActive,
              ]}
              onPress={() => setShowUrlInput(!showUrlInput)}
            >
              <LinkIcon
                size={18}
                color={showUrlInput ? '#10B981' : (isDark ? '#FFFFFF' : '#111827')}
              />
              <Text
                style={[
                  styles.mediaOptionText,
                  { color: isDark ? '#FFFFFF' : '#111827' },
                  showUrlInput && { color: '#10B981', fontWeight: '700' },
                ]}
              >
                Link
              </Text>
